...
if(isset($_POST['publish'])) {
 ...
 $data = $_POST['data'];
 $author = $userRow['name']; 
 $query = "INSERT INTO page(topic,data,author) VALUES('$topic','$data','$author')";
 ...
 $file_ext=strtolower(end(explode('.',$_FILES['upload']['name'])));
											  ...
											  if(empty($errors)==true){
												move_uploaded_file($file_tmp,"../media/page_img/".$topic.".jpg");
                                        
											  }
    
  
   $msg = "<div class='alert alert-success'>
      <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Your page was successfully created !
     </div>";
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
       ...
       <li class="treeview">
        ...
        <li class="active" class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="createpage.php"><i class="fa fa-circle"></i></i> Create Page</a></li>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Create Pages
        <small>Add pages to your site here...</small>
      </h1>
      <ol class="breadcrumb">
  ...
  ?>
              <div class="form-group">
                <input class="form-control" name="topic" placeholder="Topic of page:">
              </div>
              <div class="form-group">
