...
$uname = strip_tags($_POST['name']);
 ...
 if ($count==0) {
  ...
  $query = "INSERT INTO users(name,email,password,type) VALUES('$uname','$email','$hashed_password','$status')";

  if ($DBcon->query($query)) {
   $msg = "<div class='alert alert-success'>
      <span class='glyphicon glyphicon-info-sign'></span> &nbsp; User successfully registered !
     </div>";
  }else {
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
       ...
       <li class="treeview">
        ...
        <li class="active" class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="adduser.php"><i class="fa fa-circle"></i></i> Add User</a></li>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Add Users
        <small>Add users to your site here...</small>
      </h1>
      <ol class="breadcrumb">
