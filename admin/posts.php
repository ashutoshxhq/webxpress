      ...
      <ul class="sidebar-menu">
       ...
       <li class="active"  class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="posts.php"><i class="fa fa-circle"></i></i> Manage Post</a></li>
          </ul>
        </li>
...
<div class="box">
            <div class="box-header">
              <h3 class="box-title">Posts On Your Site</h3>
            </div>
...
if ($result->num_rows >0) {
    while($row = $result->fetch_assoc())  {
      echo '<tr>
                                 ...
                                 <td>'.$row["author"].'</td>
                                 <td>'.$row["time"].'</td>
                                 <td><div class="btn-group"><form method="post"> <input type="hidden" name="id" value="'.$row["post_id"].'"><button class="btn btn-danger" name="del" >Delete</button></form></div></td>
                              </tr>  ';
    }
