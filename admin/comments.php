...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       ...
       <li class="treeview">
        ...
        <li class="active"><a href="comments.php"><i class="fa fa-envelope"></i> <span>Comments</span></a></li>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Comments
        <small>Manage your comments here...</small>
      </h1>
      <ol class="breadcrumb">
...
if ($DBcon->query($sql) === TRUE) {
   echo '<div class="alert alert-success alert-dismissible">
                ...
                Your Comment Has been Successfully Deleated.
              </div>';
} else {
    echo "Error deleting record: " . $DBcon->error;
      ...
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">Comments On Your Site</h3>
            </div>
...
if ($result->num_rows >0) {
    while($row = $result->fetch_assoc())  {
      echo '<tr>
                                 ...
                                 <td>'.$row["post"].'</td>
                                 <td>'.$row["time"].'</td>
                                 <td><div class="btn-group"><form method="post"> <input type="hidden" name="id" value="'.$row["comment_id"].'"><button class="btn btn-danger" name="del" >Delete</button></form></div></td>
                              </tr>  ';
    }
