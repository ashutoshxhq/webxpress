       ...
       <li class="treeview">
        ...
        <li class="active" class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="pages.php"><i class="fa fa-circle"></i></i> Manage Pages</a></li>
          </ul>
        </li>
...
if ($DBcon->query($sql) === TRUE) {
   echo '<div class="alert alert-success alert-dismissible">
                ...
                Your Post Has been Successfully Deleated.
              </div>';
} else {
...
<div class="box">
            <div class="box-header">
              <h3 class="box-title">Pages On Your Site</h3>
            </div>
...
if ($result->num_rows >0) {
    while($row = $result->fetch_assoc())  {
      echo '<tr>
                                 ...
                                 <td>'.$row["author"].'</td>
                                 <td>'.$row["time"].'</td>
                                 <td><div class="btn-group"><form method="post"> <input type="hidden" name="id" value="'.$row["page_id"].'"><button class="btn btn-danger" name="del" >Delete</button></form></div></td>
                              </tr>  ';
    }
