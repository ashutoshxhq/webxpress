       ...
       <li class="treeview">
        ...
        <li class="active" class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="users.php"><i class="fa fa-circle"></i></i> Manage Users</a></li>
...
if ($DBcon->query($sql) === TRUE) {
   echo '<div class="alert alert-success alert-dismissible">
                ...
                User Has been Successfully Deleated.
              </div>';
} 
}
		 ...
		 <div class="box">
            <div class="box-header">
              <h3 class="box-title">Users On Your Site</h3>
            </div>
   ...
   if($row['type']=="master")
	...
	echo '<tr>
	 ...
	 echo '  <tr>
                                ...
                                <td>
                                  <div class="btn-group">
                                    <form method="post"> <input type="hidden" name="id" value="'.$row["user_id"].'">
