				...
				<div class="clearfix main_content floatleft">
					...
					<div class="clearfix content">
						...
						<div class="single_work_page clearfix">
							<div class="work_single_page_feature"><img style="width:100%;" src="../media/post_img/<?php echo $topic; ?>.jpg"/></div>
							<div class="work_meta clearfix">
								<p class="floatleft"> Published on: <span><?php echo $time; ?></span>Author:  <span> <?php echo $author; ?></span></p>
								<a class="floatright" href="../media/post_img/<?php echo $topic; ?>.jpg" target="_blank">Preview</a>
							</div>
